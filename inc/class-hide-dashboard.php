...
class Hide_Dashboard {
	...
	public function __construct( $plugin_file ) {
		...
		register_activation_hook( $this->plugin_file, array( 'Hide_Dashboard', 'activation_hook' ) );
		register_deactivation_hook( $this->plugin_file, array( 'Hide_Dashboard', 'deactivation_hook' ) );
		register_uninstall_hook( $this->plugin_file, array( 'Hide_Dashboard', 'uninstall_hook' ) );
